...
export const translations: {
    [key in 'FR' | 'EN']: {
        ...
        selectPayText3: string,
        // selectPayText4: string,
        saveOffre: string,
        emailOrPhone: string,
    ...
    FR: {
        ...
        errors: {
            ...
            preferenceRequired: "La préférence de rencontre est requise.",
        ...
        raise: 'Mettre en avant',
        raiseText: 'Allez en haut et faites en sorte que plus de personnes voient votre profil.'
        , increase: 'Augmentez votre visibilité',
        increaseText: 'Augmentez vos chances en invitant davantage de filles à voter pour vous et en partageant votre photo lors des rencontres.',
        ...
        textModalRaise3: 'Le service coûte 150 crédits',
